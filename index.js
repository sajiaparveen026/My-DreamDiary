      ...
      <button type='button' class='btn btn-outline-danger mr-2' name=${id} onclick="deleteTask.apply(this, arguments)">
        ...
        <div class='card-body'>
            ${
              ...
              url
                ? `<img width='100%' src=${url} alt='Card Image' class='card-img-top md-3 rounded-lg' />`
                : `<img width='100%' src="https://images4.alphacoders.com/667/thumb-1920-667452.jpg" alt='Card Image' class='card-img-top md-3 rounded-lg' />`
            }
        ...
        <div class='card-footer'>
            <button type='button' class='btn btn-outline-success float-right' data-bs-toggle="modal" data-bs-target="#showTask" onclick='openTask.apply(this, arguments)' id=${id}>View Dream</button>
        </div>
      </div>
    </div>
  `;
